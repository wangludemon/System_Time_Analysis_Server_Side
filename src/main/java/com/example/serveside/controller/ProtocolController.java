...
public class ProtocolController {
    ...
    {
        System.out.println("Resource Type: " + requestInformation.getResourceType());
        System.out.println("Resource Count: " + requestInformation.getResourceNum()); // 确认字段名是否对应
        System.out.println("Is StartUp Switch: " + requestInformation.getIsStartUpSwitch());
